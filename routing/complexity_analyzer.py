...
class ComplexityAnalyzer:
    ...
    def _load_complexity_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "length_indicators": {
                "thresholds": {"short": 100, "medium": 500, "long": 2000, "very_long": 5000},
                "weight": 0.2,
                "complexity_mapping": {"short": -0.1, "medium": 0.0, "long": 0.2, "very_long": 0.4},
            },
            "code_complexity": {
                "patterns": [
    ...
    def _load_task_type_patterns(self) -> Dict[TaskType, Dict[str, Any]]:
        ...
        return {
            ...
            TaskType.PLANNING: {
                "keywords": ["plan", "design", "architect", "structure", "organize", "strategy", "approach", "roadmap"],
                "patterns": [
    ...
    def _analyze_context_complexity(self, context: Dict[str, Any]) -> List[ComplexityIndicator]:
        ...
        if "file_types" in context:
            ...
            for file_type in file_types:
                ...
                complexity = self.file_type_complexity.get(file_type, self.file_type_complexity["default"])
            ...
            if total_complexity > 0:
                indicators.append(
                    ComplexityIndicator(
                        name="file_type_complexity", weight=0.3, score=total_complexity, evidence=evidence
                    )
                )
    ...
    def get_analysis_details(self, prompt: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        return {
            ...
            "indicators": [
                {"name": ind.name, "weight": ind.weight, "score": ind.score, "evidence": ind.evidence}
                for ind in indicators
            ],
            "total_indicators": len(indicators),
            "weighted_score": (
                sum(ind.score * ind.weight for ind in indicators) / sum(ind.weight for ind in indicators)
                if indicators
                else 0
            ),
        }
